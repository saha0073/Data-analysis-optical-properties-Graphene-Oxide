%% 
%finding chaisquare using four photon absorption 
...
t=go2d75;                             %name of input file

Intensity=233.75;                                %GW/cm^2
a=.6375;                                       %cm^-1
%for b=1:20                          %cm/GW
...
for i=1:n
    ...
    for j=2:N
        I(i,j)=I(i,j-1)-dz*(((a*I(i,j-1)*(I_sat)^3)./((I_sat)^3+(I(i,j-1)).^3))+b*(I(i,j-1)).^4);
